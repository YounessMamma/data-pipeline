# Use an appropriate base image (CPU-only)
...
# Install CPU-only PyTorch (**don't change this line**)
RUN pip install torch==1.12.0+cpu -f https://download.pytorch.org/whl/torch_stable.html --no-deps
